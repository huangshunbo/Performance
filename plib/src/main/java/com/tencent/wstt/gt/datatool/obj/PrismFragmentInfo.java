...
public class PrismFragmentInfo {
    ...
    public PrismFragmentInfo() {
    }

    public PrismFragmentInfo(String activityClassName, String activityHashCode, String fragmentClassName, String fragmentHashCode) {
    ...
    public void addAttachInfo(long start, long end) {
        for (FragmentLifecycleMethod method : fragmentLifecycleMethodList) {
            if (method.methodName.equals(FragmentLifecycleMethod.ONATTACH) && (start - method.methodStartTime) < 10) {
    ...
    public void addCreateInfo(long start, long end) {
        for (FragmentLifecycleMethod method : fragmentLifecycleMethodList) {
            if (method.methodName.equals(FragmentLifecycleMethod.ONCREATE) && (start - method.methodStartTime) < 10) {
                method.methodStartTime = start < method.methodStartTime ? start : method.methodStartTime;
                method.methodEndTime = end > method.methodEndTime ? end : method.methodEndTime;
                return;
            }
    ...
    public void addCreateViewInfo(long start, long end) {
        for (FragmentLifecycleMethod method : fragmentLifecycleMethodList) {
            if (method.methodName.equals(FragmentLifecycleMethod.ONCREATEVIEW) && (start - method.methodStartTime) < 10) {
                method.methodStartTime = start < method.methodStartTime ? start : method.methodStartTime;
                method.methodEndTime = end > method.methodEndTime ? end : method.methodEndTime;
                return;
            }
    ...
    public void addActivityCreatedInfo(long start, long end) {
        for (FragmentLifecycleMethod method : fragmentLifecycleMethodList) {
            if (method.methodName.equals(FragmentLifecycleMethod.ONACTIVITYCREATED) && (start - method.methodStartTime) < 10) {
                method.methodStartTime = start < method.methodStartTime ? start : method.methodStartTime;
                method.methodEndTime = end > method.methodEndTime ? end : method.methodEndTime;
                return;
            }
    ...
    public void addStartInfo(long start, long end) {
        for (FragmentLifecycleMethod method : fragmentLifecycleMethodList) {
            if (method.methodName.equals(FragmentLifecycleMethod.ONSTART) && (start - method.methodStartTime) < 10) {
                method.methodStartTime = start < method.methodStartTime ? start : method.methodStartTime;
                method.methodEndTime = end > method.methodEndTime ? end : method.methodEndTime;
                return;
            }
    ...
    public void addResumeInfo(long start, long end) {
        for (FragmentLifecycleMethod method : fragmentLifecycleMethodList) {
            if (method.methodName.equals(FragmentLifecycleMethod.ONRESUME) && (start - method.methodStartTime) < 10) {
                method.methodStartTime = start < method.methodStartTime ? start : method.methodStartTime;
                method.methodEndTime = end > method.methodEndTime ? end : method.methodEndTime;
                return;
            }
