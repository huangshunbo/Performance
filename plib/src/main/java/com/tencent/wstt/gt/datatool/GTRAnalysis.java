...
import com.tencent.wstt.gt.datatool.analysis.prism.PrismAppAnalysis;
import com.tencent.wstt.gt.datatool.analysis.prism.PrismLeakAnalysis;
import com.tencent.wstt.gt.datatool.analysis.prism.PrismUserTagAnalysis;
...
public class GTRAnalysis {
    ...
    AppAnalysis appAnalysis = new PrismAppAnalysis(this, appInfo);
    //Device信息：
    ...
    //tag
    ArrayList<UserTagInfo> userTagInfos = new ArrayList<>();
    PrismUserTagAnalysis prismUserTagAnalysis = new PrismUserTagAnalysis(userTagInfos);
    //leak
    ArrayList<LeakInfo> leakInfos = new ArrayList<>();
    PrismLeakAnalysis prismLeakAnalysis = new PrismLeakAnalysis(leakInfos);
...
//                break;
            ...
            case "GTRFlagRecord":
                ...
                break;
            case "tagCollect":
                String tagStart = data[3];
                String tagend = data[4];
                String tagMethod = data[5];
                String tagClass = data[6];
                String tagHashCode = data[7];
                prismUserTagAnalysis.collectTagInfo(tagClass,tagMethod,tagHashCode,tagStart,tagend);
                break;
            case "leakCollect":
                String leakTime = data[3];
                String leakClassName = data[4];
                prismLeakAnalysis.collectLeakInfo(leakTime,leakClassName);
                break;
            default:
    ...
    public ArrayList<UserTagInfo> getUserTagInfos() {
        return userTagInfos;
    }

    public ArrayList<LeakInfo> getLeakInfos() {
        return leakInfos;
    }
